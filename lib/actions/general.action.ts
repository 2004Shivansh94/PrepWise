  ...
  try {
    ...
    const { text } = await generateText({
      ...
      prompt: `
        ...
        Do not include markdown formatting, backticks, or any conversational filler. Return just the raw JSON string.
        `,
      system:
...
export async function createResumeInterview(
  params: CreateResumeInterviewParams
) {
  try {
